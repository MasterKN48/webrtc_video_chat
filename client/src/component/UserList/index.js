  ...
  return (
    <div>
      <div className="card bg-primary shadow-inset border-light">
        <h2 className="card-title mx-2 my-2 alert alert-secondary shadow-soft">
        ...
        <div className="pb-2">
          {users.map(({ name, id }) => (
            <div key={id}>
              {user === id ? (
                <div className="card mx-2 my-2 bg-primary shadow-inset">
                ...
                <div className="card mx-2 my-1 bg-primary shadow-inset">
