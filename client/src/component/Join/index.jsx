...
const Join = () => {
  ...
  const submit = (e) => {
    ...
    if (!name || name.length < 1 || name.length > 100) {
      Status({
        text: "<h5>Name is required and must have 1 to 100 letters.</h5>",
        type: "warning",
      });
      return;
    }
    if (!room || room.length < 1 || room.length > 100) {
      Status({
        text: "<h5>Room name is required and must have 1 to 100 letters.</h5>",
        type: "warning",
      });
      return;
    }
